        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="p-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              {/* Save for Later */}
              <button className="flex-1 border-2 border-blue-600 text-blue-600 px-8 py-4 rounded-lg hover:bg-blue-50 transition font-semibold text-lg inline-flex items-center justify-center gap-2">
                ❤️ Save for Later
              </button>
            </div>
